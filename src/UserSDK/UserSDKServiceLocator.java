...
public class UserSDKServiceLocator extends org.apache.axis.client.Service implements UserSDK.UserSDKService {
    ...
    private java.lang.String UserSDKPort_address = "https://crumpets.qa.granicus.com/sdk/user/index.php";
    ...
    public UserSDK.UserSDKPort getUserSDKPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            UserSDK.UserSDKBindingStub _stub = new UserSDK.UserSDKBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (UserSDK.UserSDKPort.class.isAssignableFrom(serviceEndpointInterface)) {
                UserSDK.UserSDKBindingStub _stub = new UserSDK.UserSDKBindingStub(new java.net.URL(UserSDKPort_address), this);
                _stub.setPortName(getUserSDKPortWSDDServiceName());
                return _stub;
            }
        }
