...
public class KeyBasedPlatformClient extends PlatformClientStub {
    ...
    public KeyBasedPlatformClient(String site) throws AxisFault, MalformedURLException {
       super(site);
    }

    public KeyBasedPlatformClient(String site, String preSharedKey, String keyType) throws RemoteException, MalformedURLException, InvalidAlgorithmParameterException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InterruptedException, IllegalBlockSizeException, BadPaddingException, XMLSignatureException {
        this(site);
