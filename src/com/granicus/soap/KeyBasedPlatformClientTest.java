 ...
 */
public class KeyBasedPlatformClientTest {
    KeyBasedPlatformClient client;
    String preSharedKey;
    String keyType;
    String host;
    ...
    public void setUp() throws Exception {
        ...
        client = new KeyBasedPlatformClient(host, preSharedKey, keyType);
    }
    ...
    public void testLogin() throws Exception {
        Assert.assertEquals("administrator", client.getCurrentUserLogon().toLowerCase());
    }

    @Test
    public void testImpersonation() throws Exception {
        KeyBasedPlatformClient client2 = new KeyBasedPlatformClient(host);
